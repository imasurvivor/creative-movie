...
exports.default = {
    ...
    async mobileInstallApp(app, timeoutMs, strategy, checkVersion) {
        ...
        if (checkVersion) {
            const bundleId = await (0, app_utils_1.extractBundleId)(srcAppPath);
        ...
        await this.device.installApp(srcAppPath, timeoutMs ?? this.opts.appPushTimeout, strategy ?? this.opts.appInstallStrategy);
